...
async def suggest_cards(
    ...
    Example prompts:
    - "recommend ramp cards for this deck"
    - "find all goad cards in red for commander"
    - "find a budget replacement for Smothering Tithe"
    - "what should I cut from this deck?"
    - "list the best mana dorks in green blue white and black"
    """
    deck_cards = None
    deck_info = None

    # If deck_id provided, load deck context
    if request.deck_id:
